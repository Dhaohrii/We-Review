      ...
      <div className="container">
        <div className={styles.flexContainer}>
          <div className={styles.flexItem}>
            <img
              className={`${styles.aboutUsImage} img-fluid`}
              loading="lazy"
              src="https://cdn.shopify.com/s/files/1/0352/3140/0072/products/VolcanDeMiTierraXATequila_bb21b89b-07f3-4108-a1dd-bc5985b11238.webp?v=1677095584"
              alt="About 6"
            />
          </div>
          <div className={styles.flexItem}>
            <div className="accordion" id="accordionAbout6">
              <div className={`${styles.aboutUsAccordionItem} accordion-item mb-4 border border-dark`}>
                <h2 className="accordion-header" id="headingOne">
                  <button
                    className={`${styles.accordionButton} accordion-button fs-4`}
                    type="button"
              ...
              <div className={`${styles.aboutUsAccordionItem} accordion-item mb-4 border border-dark`}>
                <h2 className="accordion-header" id="headingTwo">
                  <button
                    className={`${styles.accordionButton} accordion-button collapsed fs-4`}
                    type="button"
                    data-bs-toggle="collapse"
